...
# these are all from the formula cookbook or run by homebrew-core CI:
set -v # print shell input lines as they are read
brew audit --new-formula "$FORMULA_NAME" || die "FAILED: brew audit --new-formula"
brew audit --strict --online "$FORMULA_NAME" || die "FAILED: brew audit --strict --online"
brew style --formula "$FORMULA_NAME" || die "FAILED: brew style"
